				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<select name="jenis_penjahit" class="form-control" required="required">
                            ...
                            <option selected value="<?php echo $jenis_penjahit_id; ?>"><?php echo $nama_jenis; ?></option>
                            <?php 
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<select name="jenis_mesin" class="form-control" required="required">
                            <option value="">Pilih</option>
                            <option selected value="<?php echo $jenis_mesin_id; ?>"><?php echo $nama_mesin; ?></option>
                            <?php 
							             ...
							             <div class="col-lg-1">
							                <div class="thumbnail">
							                    <div class="thumb">
							                        ...
							                        <div class="caption-overflow">
							                            <span>
							                                <a href="<?php echo base_url() ?>data_penjahit/add_images/<?php echo $this->uri->segment(3); ?>" data-popup="lightbox" rel="gallery" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-file-plus"></i></a>
							                            </span>
							                        </div>
							                    </div>
							                </div>
