<div class="panel panel-flat">
	...
	<div class="panel-body">
		<div class="row">
			<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>lokasi_user/process_add_images">
				            ...
				            <div class="thumb">
				                ...
				                <div class="caption-overflow">
				                    <span>
				                        ...
				                        <a href="<?php echo base_url() ?>lokasi_user/delete_images/<?php echo $key->id.'/'.$i; ?>" data-popup="lightbox" rel="gallery" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-cross"></i></a>
				                    </span>
				                </div>
				            </div>
				        </div>
		...
		<div class="row">
			<button onclick="window.location.href='<?php echo base_url(); ?>lokasi_user/'" class="btn btn-primary"><i class="icon-zoomin3"></i>View Detail</button>
		</div>
	</div>
</div>